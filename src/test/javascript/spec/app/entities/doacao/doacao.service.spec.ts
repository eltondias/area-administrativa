...
describe('Service Tests', () => {
  describe('Doacao Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(DoacaoService);
      httpMock = injector.get(HttpTestingController);
      currentDate = moment();

      elemDefault = new Doacao(0, 'AAAAAAA', 0, false, false, currentDate);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Doacao', async () => {
        const returnedFromService = Object.assign(
          {
            id: 0,
            dataHora: currentDate.format(DATE_TIME_FORMAT)
      ...
      it('should return a list of Doacao', async () => {
        const returnedFromService = Object.assign(
          {
            descricao: 'BBBBBB',
            quantidade: 1,
